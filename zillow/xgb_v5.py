...
df_train = pd.concat([df_train, airconditioningtypeid_encoded, archtype_encoded, buildingclass_encoded, heatingtype_encoded, propertyid_encoded], axis=1)
...
variables = features[0:84]
response = features[84]
...
sub["201611"] = p_test_oct
sub["201612"] = p_test_oct
sub["201710"] = p_test_oct
sub["201711"] = p_test_oct
sub["201712"] = p_test_oct
